  ...
  return (function () {
    var t = {
        ...
        3729: function (t, e, n) {
          ...
          var _ = k,
            L = n(6775);
          const S = ['insertText', 'insertReplacementText'];
          class O extends x.A {
            constructor(t, e) {
              super(t, e),
          ...
          var T = O;
          const j = /Mac/i.test(navigator.platform);
          class C extends x.A {
            isListening = !1;
        ...
        5036: function (t, e, n) {
          ...
          var x = class {
            ...
            k = n(9609),
            _ = n(6775);
          const L = ['block', 'break', 'cursor', 'inline', 'scroll', 'text'];
          const S = (t) => {
          ...
          class R {
            ...
            constructor(t) {
              ...
              if (
                ((this.options = (function (t, e) {
                  ...
                  const s =
                    !e.theme || e.theme === R.DEFAULTS.theme
                      ? k.A
                      : R.import(`themes/${e.theme}`);
                  if (!s)
                    throw new Error(
                      `Invalid theme ${e.theme}. Did you register it?`
                    );
                  const { modules: o, ...l } = R.DEFAULTS,
                    { modules: a, ...c } = s.DEFAULTS,
                    u = (0, r.A)({}, B(o), B(a), B(e.modules));
                  null != u &&
                    u.toolbar &&
                ...
                return void j.error('Invalid Quill container', t);
              ...
              if (
                ...
                this.emitter.on(N.A.events.SCROLL_UPDATE, (t, e) => {
                  const n = e.map((t) => ({
                    target: t.target.textContent,
                    type: t.type,
                  }));
                  (0, _.P)(
                    JSON.stringify(
                      { source: t, mutationsFormatted: n },
                      null,
                      2
                    ),
                    { backgroundColor: 'green', color: 'white', timeout: 3e3 }
                  );
                  const r = this.selection.lastRange,
                    [i] = this.selection.getRange(),
                    s = r && i ? { oldRange: r, newRange: i } : void 0;
                  U.call(this, () => this.editor.update(null, e, s), t);
                }),
              ...
              let t =
                ...
                e =
                  arguments.length > 1 && void 0 !== arguments[1]
                    ? arguments[1]
                    : this.getLength() - t;
              return ([t, e] = D(t, e)), this.editor.getContents(t, e);
            }
            getFormat() {
              let t =
                  arguments.length > 0 && void 0 !== arguments[0]
          ...
          function U(t, e, n, r) {
            ...
            if (
              (null != i &&
                (!0 === n && (n = i.index),
                null == r ? (i = P(i, l, e)) : 0 !== r && (i = P(i, n, r, e)),
        ...
        8123: function (t, e, n) {
          ...
          class f extends c.A {
            ...
            listen() {
              this.quill.root.addEventListener('keydown', (t) => {
                ...
                if (0 === e.length) return;
                const n = u.Ay.find(t.target, !0);
                if (n && n.scroll !== this.quill.scroll) return;
                const i = this.quill.getSelection();
                if (null == i || !this.quill.hasFocus()) return;
                const [o, l] = this.quill.getLine(i.index),
                  [a, c] = this.quill.getLeaf(i.index),
                  [h, d] =
                    0 === i.length
                      ? [a, c]
                      : this.quill.getLeaf(i.index + i.length),
                  p = a instanceof s.TextBlot ? a.value().slice(0, c) : '',
                  g = h instanceof s.TextBlot ? h.value().slice(d) : '',
                  m = {
                    collapsed: 0 === i.length,
                    empty: 0 === i.length && o.length() <= 1,
            ...
            handleBackspace(t, e) {
              ...
              let s = new (l())().retain(t.index - n).delete(n);
              if (0 === e.offset) {
              ...
              this.quill.updateContents(s, u.Ay.sources.USER),
                this.quill.focus();
            }
            handleDelete(t, e) {
              ...
              let r = {};
              const [i] = this.quill.getLine(t.index);
              let s = new (l())().retain(t.index).delete(n);
              if (e.offset >= i.length() - 1) {
                const [e] = this.quill.getLine(t.index + 1);
                if (e) {
                  const n = i.formats(),
                    l = this.quill.getFormat(t.index, 1);
                  (r = o.AttributeMap.diff(n, l) || {}),
                    Object.keys(r).length > 0 &&
                      (s = s.retain(e.length() - 1).retain(1, r));
                }
              }
              this.quill.updateContents(s, u.Ay.sources.USER),
                this.quill.focus();
            ...
            handleEnter(t, e) {
              const n = Object.keys(e.format).reduce(
                  (t, n) => (
                    this.quill.scroll.query(n, s.Scope.BLOCK) &&
                ...
                r = new (l())()
                  ...
                  .delete(t.length)
                  .insert('\n', n);
              this.quill.updateContents(r, u.Ay.sources.USER),
                this.quill.setSelection(t.index + 1, u.Ay.sources.SILENT),
                this.quill.focus();
            }
          }
          const p = {
            bindings: {
              ...
              'indent': {
                ...
                handler(t, e) {
                  return (
                    ...
                    (this.quill.format('indent', '+1', u.Ay.sources.USER), !1)
                  );
                },
              },
              'outdent': {
              ...
              'outdent backspace': {
                ...
                handler(t, e) {
                  null != e.format.indent
                    ? this.quill.format('indent', '-1', u.Ay.sources.USER)
                    : null != e.format.list &&
                      this.quill.format('list', !1, u.Ay.sources.USER);
                },
              },
              ...
              'remove tab': {
                ...
                prefix: /\t$/,
                handler(t) {
                  this.quill.deleteText(t.index - 1, 1, u.Ay.sources.USER);
                },
              },
              'tab': {
                key: 'Tab',
                handler(t, e) {
                  ...
                  const n = new (l())()
                    ...
                    .insert('\t');
                  return (
                    this.quill.updateContents(n, u.Ay.sources.USER),
                    this.quill.history.cutoff(),
                    this.quill.setSelection(t.index + 1, u.Ay.sources.SILENT),
                    !1
                  );
              ...
              'blockquote empty enter': {
                ...
                empty: !0,
                handler() {
                  this.quill.format('blockquote', !1, u.Ay.sources.USER);
                },
              },
              'list empty enter': {
                key: 'Enter',
              ...
              'checklist enter': {
                ...
                handler(t) {
                  ...
                  this.quill.updateContents(i, u.Ay.sources.USER),
                    this.quill.setSelection(t.index + 1, u.Ay.sources.SILENT),
                    this.quill.scrollSelectionIntoView();
                },
              },
              ...
              'table enter': {
                ...
                handler(t) {
                  ...
                  if (e) {
                    ...
                    let a = n.offset();
                    if (o < 0) {
                      const e = new (l())().retain(a).insert('\n');
                      this.quill.updateContents(e, u.Ay.sources.USER),
                        this.quill.setSelection(
                          t.index + 1,
                          t.length,
                          u.Ay.sources.SILENT
                      ...
                      a += n.length();
                      const t = new (l())().retain(a).insert('\n');
                      this.quill.updateContents(t, u.Ay.sources.USER),
                        this.quill.setSelection(a, u.Ay.sources.USER);
                    }
                  }
                },
              },
              'table tab': {
                ...
                handler(t, e) {
                  ...
                  n.shiftKey
                    ? this.quill.setSelection(i - 1, u.Ay.sources.USER)
                    : this.quill.setSelection(
                        i + r.length(),
                        u.Ay.sources.USER
                      );
              ...
              'list autofill': {
                ...
                handler(t, e) {
                  ...
                  this.quill.insertText(t.index, ' ', u.Ay.sources.USER),
                    this.quill.history.cutoff();
                  const o = new (l())()
                    .retain(t.index - i)
                    .delete(n + 1)
                    ...
                    .retain(1, { list: s });
                  return (
                    this.quill.updateContents(o, u.Ay.sources.USER),
                    this.quill.history.cutoff(),
                    this.quill.setSelection(t.index - n, u.Ay.sources.SILENT),
                    !1
                  );
                },
              },
            ...
            return {
              ...
              handler(e, n) {
                ...
                if (0 === e.length && !r.shiftKey)
                  return (
                    this.quill.insertText(e.index, s, u.Ay.sources.USER),
                ...
                o.forEach((e, n) => {
                  t
                    ? (e.insertAt(0, s),
                      0 === n ? (l += s.length) : (a += s.length))
                    : e.domNode.textContent.startsWith(s) &&
                      (e.deleteAt(0, s.length),
                      0 === n ? (l -= s.length) : (a -= s.length));
                }),
                  this.quill.update(u.Ay.sources.USER),
                  this.quill.setSelection(l, a, u.Ay.sources.SILENT);
              },
            };
          }
          function m(t, e) {
                ...
                return !(
                  ...
                  ('ArrowLeft' === t
                    ? e
                      ...
                      : this.quill.setSelection(n.index - 1, u.Ay.sources.USER)
                    : e
                      ? this.quill.setSelection(
                          n.index,
                          n.length + 1,
          ...
          function b(t) {
            return {
              ...
              shortKey: !0,
              handler(e, n) {
                this.quill.format(t, !n.format[t], u.Ay.sources.USER);
              },
            };
          }
          function y(t) {
              ...
              handler(e, n) {
                ...
                if (null != s) {
                  if ('table-row' === s.statics.blotName) {
                    ...
                    this.quill.setSelection(r, 0, u.Ay.sources.USER);
                  }
                } else {
                  const e = i.table()[r];
                  null != e &&
          ...
          function v(t) {
            ...
            e.deleteText(n, u.Ay.sources.USER),
              Object.keys(i).length > 0 &&
                e.formatLine(n.index, 1, i, u.Ay.sources.USER),
              e.setSelection(n.index, u.Ay.sources.SILENT);
          }
          f.DEFAULTS = p;
        },
        8920: function (t) {
